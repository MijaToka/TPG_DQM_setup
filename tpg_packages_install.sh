...
pushd $CMSSW_BASE/src
    ...
    # git cms-merge-topic -u MijaToka:dev/trigmapping_hgcal_up2date # trggmapping_hgcal_up2date
    ...
    git clone https://gitlab.cern.ch/ttravis/hgcal-comm.git HGCalCommissioning
    pushd HGCalCommissioning
        git checkout origin/rebased/dev-mtokarev-trigger
    popd
    #update cell map
